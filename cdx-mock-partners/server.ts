...
function listVendors(): VendorCatalogEntry[] {
  ...
  return [
    {
      id: 'glia',
      description: 'Glia chat-bubble loader (single-script bootstrap pattern)',
      scriptPath: '/vendors/glia/sdk.js',
      cssPath: '/vendors/glia/sdk.css',
      templateId: 'vendor-script-loader',
      defaults: {vendorScriptUrl: `${b}/vendors/glia/sdk.js`},
    },
    {
      id: 'link-live',
      description: 'Link Live chat (CSS URL + content URL globals + script bootstrap)',
      scriptPath: '/vendors/link-live/aspect.js',
      cssPath: '/vendors/link-live/aspect.css',
      templateId: 'vendor-script-with-config',
      defaults: {
        vendorScriptUrl: `${b}/vendors/link-live/aspect.js`,
        cssUrl: `${b}/vendors/link-live/aspect.css`,
        contentUrl: `${b}/link-live/handoff/retail`,
      },
    },
    {
      id: 'gtm',
      description: 'Google Tag Manager bootstrap (dataLayer + script tag injection)',
      scriptPath: '/vendors/gtm/gtm.js',
      templateId: 'tag-manager',
      defaults: {
        vendorScriptUrl: `${b}/vendors/gtm/gtm.js`,
        gtmContainerId: 'GTM-MOCK000',
      },
    },
    {
      id: 'salesforce',
      description: 'Salesforce Embedded Service chat (personalized, web)',
      scriptPath: '/vendors/salesforce/embedded.js',
      templateId: 'vendor-sdk-personalized',
      defaults: {
        vendorScriptUrl: `${b}/vendors/salesforce/embedded.js`,
        vendorOrgId: '00DMOCKSALESFORCE0',
    ...
    {
      id: 'five9',
      description: 'Five9 chat plugin (personalized, web)',
      scriptPath: '/vendors/five9/chat.js',
      templateId: 'vendor-sdk-personalized',
      defaults: {
        vendorScriptUrl: `${b}/vendors/five9/chat.js`,
    ...
    {
      id: 'acquire',
      description: 'Acquire chat / co-browse (personalized, web)',
      scriptPath: '/vendors/acquire/widget.js',
      templateId: 'vendor-sdk-personalized',
      defaults: {
        vendorScriptUrl: `${b}/vendors/acquire/widget.js`,
    ...
    {
      id: 'ujet-mobile',
      description: 'UJET mobile chat (JSBridge token + WebView SDK)',
      scriptPath: '/vendors/ujet/mobile.js',
      templateId: 'mobile-vendor-chat-jsbridge',
      defaults: {
        vendorScriptUrl: `${b}/vendors/ujet/mobile.js`,
        vendorAppName: 'mock-mobile-tenant',
        tokenEndpoint: `${b}/token`,
      },
    },
    {
      id: 'salesforce-mobile',
      description: 'Salesforce mobile chat (JSBridge token + WebView SDK)',
      scriptPath: '/vendors/salesforce/mobile.js',
      templateId: 'mobile-vendor-chat-jsbridge',
      defaults: {
        vendorScriptUrl: `${b}/vendors/salesforce/mobile.js`,
        vendorOrgId: '00DMOCKSALESFORCE0',
